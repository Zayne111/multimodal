...
def main(cfg, gpu, save_dir):
    ...
    resume_path = cfg['MODEL'].get('RESUME', None)
    ...
    if train_cfg['DDP']: 
        ...
        sampler_val = None
        model = DDP(model, device_ids=[gpu], output_device=0, broadcast_buffers=False, find_unused_parameters=True)
    else:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='/root/multimodal/configs/mcubes.yaml', help='Configuration file to use')
